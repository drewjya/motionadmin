...
const formD = useFormd({
  schema: z.object({
    ...
    berita: z.string({
      required_error: "Berita is required",
      invalid_type_error: "Berita must be a string",
    }),
  }),
...
<template>
  <v-form :form="formD" class="flex flex-col gap-4">
    ...
    <v-editor v-model="formD.state.berita" />
    <div v-html="formD.state.berita"></div>
    <u-button
